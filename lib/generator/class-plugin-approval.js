...
EOD;
        ...
        echo <<< EOD
            ...
            <a class="button button-primary" href="$current_page_url&action=approval" onClick="appendParameters(this)">承認する</a>
            <a class="button delete" href="$current_page_url&action=reject" onClick="appendParameters(this)">却下する</a>
        </div>
EOD;
