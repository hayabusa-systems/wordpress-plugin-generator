...
const plugin_library_generator = require('./generator/class-plugin-library.js');
const plugin_approval_generator = require('./generator/class-plugin-approval.js');
...
const setup = function(config) {
  ...
  fs.mkdirSync('./dist/' + plugin.name + '/includes/library');
  fs.mkdirSync('./dist/' + plugin.name + '/includes/approval');
  ...
  plugin_library_generator(config);
  plugin_approval_generator(config);
